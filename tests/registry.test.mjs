...
test("可信 registry sequence=14 绑定批准证据、候选提交、实现摘要和新 producer", async () => {
  ...
  assert.equal(record.sequence, 14);
  assert.equal(record.sourceCommit, "6dcb03d93046b7c739fd5017d5587d5fb052c55d");
  assert.equal(
