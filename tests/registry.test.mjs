...
test("可信 registry sequence=13 绑定批准证据、候选提交、实现摘要和新 producer", async () => {
  ...
  assert.equal(record.sequence, 13);
  assert.equal(record.sourceCommit, "eb4665fe3f65ca172f3a38506976e8424c759612");
  assert.equal(
  ...
  assert.equal(approval.producerWorkflowSha, "d49aec5544cbfece9451c92a1c0de91a9fdb6ceb");
  assert.doesNotThrow(() =>
    validateTrustedRegistryApproval({
      approval,
