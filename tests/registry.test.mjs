...
test("可信 registry sequence=15 绑定批准证据、候选提交、实现摘要和新 producer", async () => {
  ...
  assert.equal(record.sequence, 15);
  assert.equal(record.sourceCommit, "7d600fd8f0f5752c8cbd3ec6aac1a61b97e01733");
  assert.equal(
  ...
  assert.equal(approval.producerWorkflowSha, "48a9ee8b1034f4b656a209bc6f1138dcd3755311");
  assert.doesNotThrow(() =>
    validateTrustedRegistryApproval({
      approval,
