...
export function validateTrustedRegistryApproval({
  ...
  if (
    ...
    approval.approvalKind !== "gate-registry-producer-migration" ||
    ...
    !digestPattern.test(approval.previousGateRegistryDigest) ||
    !/^[a-f0-9]{40}$/u.test(approval.previousProducerWorkflowSha) ||
    approval.previousProducerWorkflowSha === approval.producerWorkflowSha ||
